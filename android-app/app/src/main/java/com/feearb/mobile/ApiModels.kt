...
data class PositionSummaryDto(
    ...
    val current_exposure_usdt: Double? = null,
    val gross_current_exposure_usdt: Double? = null,
    val entry_exposure_usdt: Double? = null,
    val gross_entry_exposure_usdt: Double? = null,
...
data class PositionLegDto(
    ...
    val current_notional: Double? = null,
    val entry_notional: Double? = null,
    val exchange_notional: Double? = null,
    val entry_price: Double? = null,
    val mark_price: Double? = null,
    val current_mark_price: Double? = null,
    val mark_price_source: String? = null,
    val valuation_status: String? = null,
    val unrealized_pnl: Double? = null,
    val funding_rate: Double? = null,
    val funding_interval_hours: Double? = null,
    val next_funding: String? = null,

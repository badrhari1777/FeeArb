...
_RAW_LOGGER = logging.getLogger("ws_trade_raw")
if not _RAW_LOGGER.handlers:
    _RAW_LOGGER.setLevel(logging.INFO)
    log_path = BASE_DIR / "logs" / "ws_trade_raw.log"
...
class WsTradeRawStream:
    ...
    async def _connect(self) -> None:
        ...
        await self._log_line("[sys] connected to bybit trade ws")
